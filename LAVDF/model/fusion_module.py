...
class ModalFeatureAttnBoundaryMapFusion(Module):
    ...
    def __init__(self, n_video_features: int = 257, n_audio_features: int = 257, max_duration: int = 40):
        ...
        self.a_attn_block = self.ModalAttnBlock(n_audio_features, n_video_features, max_duration)
        self.v_attn_block = self.ModalAttnBlock(n_video_features, n_audio_features, max_duration)
